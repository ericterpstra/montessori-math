...
- [x] Golden beads: exchanging 10 units yields exactly 1 ten-bar (both directions); dynamic addition 1,568 + 1,679 walks through 3 exchanges and shows 3,247
- [x] Stamp game: subtraction 4,053 − 1,278 requires borrowing across a zero and yields 2,775
- [x] Racks & tubes: 9,764 ÷ 4 → 2,441; guided mode refuses out-of-sequence moves; remainder shown for 9,765 ÷ 4
- [x] Hundred board: skip-count mode highlights correct multiples for 2–10
- [x] Checkerboard: 4,357 × 23 = 100,211 via partial products and diagonal slide
- [x] Snake game: any snake's total preserved through golden-bead exchange
- [x] Bead frame: place values carried correctly across all 7 wires (large frame)
- [x] Decimal board: comparisons and +/− exact to thousandths (no floating-point drift)

## Definition of done

- [x] All 19 registered, reachable from `/materials`, tests green, build green
- [x] Each links to ≥1 album lesson and related worksheet generators
